...
风格名称、描述、适用场景和提示词以这张[飞书多维表格](https://xcn5phmhnu1z.feishu.cn/base/JvecbWMEwaLv8as3NGXcQxjgnn9?table=tbl1DwIeLHneaDRX&view=vew2lCosPH)为权威来源。仓库内的 [`references/style-catalog.md`](references/style-catalog.md) 是当前同步副本。
